          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div>
              ...
              <div className="mt-2">
                ...
                />
                {errors.user && <span class="text-red-500 text-xs block">Usuario es requerido</span>}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                />
                 {errors.password && <span class="text-red-500 text-xs block">Contraseña es requerido</span>}
              </div>
            </div>
